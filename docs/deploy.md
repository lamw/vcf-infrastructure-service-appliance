...
```text
vcf-infrastructure-services-appliance-1.0.2.ova.part-aa
vcf-infrastructure-services-appliance-1.0.2.ova.part-ab
vcf-infrastructure-services-appliance-1.0.2.ova.part-ac
vcf-infrastructure-services-appliance-1.0.2.ova.sha256
vcf-infrastructure-services-appliance-1.0.2.ova.parts.sha256
```

Verify the downloaded parts first:

```shell
shasum -a 256 -c vcf-infrastructure-services-appliance-1.0.2.ova.parts.sha256
```
...
```shell
cat vcf-infrastructure-services-appliance-1.0.2.ova.part-* > vcf-infrastructure-services-appliance-1.0.2.ova
```

* Windows PowerShell
```shell
cmd /c 'copy /b vcf-infrastructure-services-appliance-1.0.2.ova.part-a* vcf-infrastructure-services-appliance-1.0.2.ova'
```
...
```shell
shasum -a 256 -c vcf-infrastructure-services-appliance-1.0.2.ova.sha256
```
...
shasum -a 256 vcf-infrastructure-services-appliance-1.0.2.ova > vcf-infrastructure-services-appliance-1.0.2.ova.sha256
split -b 1900m vcf-infrastructure-services-appliance-1.0.2.ova vcf-infrastructure-services-appliance-1.0.2.ova.part-
shasum -a 256 vcf-infrastructure-services-appliance-1.0.2.ova.part-* > vcf-infrastructure-services-appliance-1.0.2.ova.parts.sha256
```
