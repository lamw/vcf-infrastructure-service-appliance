...
vcf-infrastructure-services-appliance-1.0.1.ova.parts.sha256
```

Verify the downloaded parts first:

```shell
shasum -a 256 -c vcf-infrastructure-services-appliance-1.0.1.ova.parts.sha256
```
...
```shell
cat vcf-infrastructure-services-appliance-1.0.1.ova.part-* > vcf-infrastructure-services-appliance-1.0.1.ova
```

* Windows PowerShell
```shell
cmd /c 'copy /b vcf-infrastructure-services-appliance-1.0.1.ova.part-a* vcf-infrastructure-services-appliance-1.0.1.ova'
```
...
```shell
shasum -a 256 -c vcf-infrastructure-services-appliance-1.0.1.ova.sha256
```
...
shasum -a 256 vcf-infrastructure-services-appliance-1.0.1.ova.part-* > vcf-infrastructure-services-appliance-1.0.1.ova.parts.sha256
```
